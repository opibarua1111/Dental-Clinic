        ...
        <div className="relative bg-white border border-gray-100 transition transform duration-700 hover:shadow-xl hover:scale-105 p-3 rounded-lg">
            ...
            <div className="flex flex-col items-center my-3 space-y-2">
                ...
                <Link to={`/servicedetail/${id}`}>
                    <button className="bg-green-400 hover:bg-green-500 text-white px-8 py-2 duration-300 hover:scale-110 focus:outline-none poppins rounded-full mt-4 transform transition">More Details</button>
                </Link>
            </div>
        </div>
    );

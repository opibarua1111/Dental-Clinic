...
const Footer = () => {
    ...
    return (
        <div className="w-full h-60 bg-green-300  ">
            <div className='container grid grid-cols-1 md:grid-cols-3 lg:grid-cols-3 lg:gap-5'>
                <div className=" text-center">
                    <img className="mx-auto w-20 pt-2" src="https://i.ibb.co/wKZ2JX3/dental-logo.png" alt="" />
